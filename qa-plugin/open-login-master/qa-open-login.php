...
<?php
			...
			$logo = "qa-plugin/open-login-master/images/".$this->provider.".png";
?>
  <a class="open-login-button openid_large_btn context-<?php echo $classes ?>" style="background: #fff url(<?php echo $logo ?>); background-size: 100% 100%; " title="<?php echo $title;?>" href="<?php echo $url ?>"></a>
<?php 
		}
