	...
	function load_module($directory, $urltoroot)
	{
		...
		function output_widget($region, $place, $themeobject, $template, $request, $qa_content)
		{
			...
			$code = array(
				...
				'email'=>'<a title="Share this question via email" id="share-button-email" href="mailto:?subject='.rawurlencode('['.qa_opt('site_title').'] '.@$qa_content['q_view']['raw']['title']).'&body='.rawurlencode($url).'"><img src="'.$this->urltoroot.'qa-share-mail.png'.'"/></a>'
