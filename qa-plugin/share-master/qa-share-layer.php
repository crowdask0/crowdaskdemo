...
'.qa_opt('share_plugin_css').'				
		...
		function q_view_buttons($q_view) {
			...
			if($buttons && qa_opt('share_plugin_suggest')) {
		...
		function qa_share_buttons($q_view) {
			...
			$link_to_share = qa_path_html(qa_q_request($this->content['q_view']['raw']['postid'], $this->content['q_view']['raw']['title']), null, qa_opt('site_url'));
			
			$code = array(
				'facebook'=> '<div class="fb-share-button" data-href="'.qa_path_html(qa_q_request($this->content['q_view']['raw']['postid'], $this->content['q_view']['raw']['title']), null, qa_opt('site_url')).'" data-type="button"></div>',
